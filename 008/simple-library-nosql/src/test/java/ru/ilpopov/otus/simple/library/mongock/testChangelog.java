...
public class testChangelog {
    ...
    public void insertBookOne(BookDao repository) {
    ...
    public void insertBookTwo(BookDao repository) {
    ...
    public void insertBookThree(BookDao repository) {
    ...
    public void insertBookFour(BookDao repository) {
    ...
    public void insertComment1ForBookOne(CommentDao repository, BookDao bookDao) {
        Book book = bookDao.findByTitleContaining("Книга 1")
                .stream()
                .findFirst()
                .orElse(null);
    ...
    public void insertComment2ForBookOne(CommentDao repository, BookDao bookDao) {
        Book book = bookDao.findByTitleContaining("Книга 1")
                .stream()
                .findFirst()
                .orElse(null);
    ...
    public void insertComment3ForBookOne(CommentDao repository, BookDao bookDao) {
        Book book = bookDao.findByTitleContaining("Книга 1")
                .stream()
                .findFirst()
                .orElse(null);
    ...
    public void insertComment1ForBookTwo(CommentDao repository, BookDao bookDao) {
        Book book = bookDao.findByTitleContaining("Книга 2")
                .stream()
                .findFirst()
                .orElse(null);
    ...
    public void insertBookRemoveByIdWithComments(BookDao bookDao, CommentDao commentDao) {
        ...
        commentDao.saveAll(Set.of(commentOne, commentTwo));
    }

    @ChangeSet(order = "010", id = "insertBookRemoveWithComments", author = "ipopov")
    public void insertBookRemoveWithComments(BookDao bookDao, CommentDao commentDao) {
